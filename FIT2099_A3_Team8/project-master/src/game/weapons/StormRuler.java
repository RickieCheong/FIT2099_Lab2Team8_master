...
//        this.allowableActions.add(new ChargeAction(this, 3));
    ...
    public int damage() {
        ...
        if (chances == 1 && this.hasCapability(PassiveSkills.CRITICAL_STRIKE) && !this.hasCapability(Status.STRIKING)) {
            return damage * 2;
    ...
    public void tick(Location currentLocation, Actor actor) {
        if (this.hasCapability(Status.PICK_UP)){
            this.allowableActions.add(new ChargeAction(this, this.maxNumberOfCharge));
            this.removeCapability(Status.PICK_UP);
        }
    ...
    public PickUpItemAction getPickUpAction(Actor actor) {
        this.addCapability(Status.PICK_UP);
