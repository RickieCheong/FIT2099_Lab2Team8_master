...
public class Token extends Item implements Soul, Resettable {
    ...
    public void tick(Location currentLocation, Actor actor) {
        if(actor.hasCapability(Status.HOSTILE_TO_ENEMY) && actor.getInventory().contains(this)){
     ...
     * Reset for the Token
     *
     * @param map GameMap of the Token
     */
    @Override
