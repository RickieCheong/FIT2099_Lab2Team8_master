...
public class SwapWeaponAction extends PickUpItemAction {
    ...
    /**
     * Constructor of the Swap Weapon Action class
    ...
    /**
     * Performs the action of swapping a weapon
     *
     * @param actor The actor performing the action.
     * @param map The map the actor is on.
     * @return Returns a descriptive message when a weapon has been swapped
     */
    @Override
