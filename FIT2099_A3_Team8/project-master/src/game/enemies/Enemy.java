    ...
    public Actions getAllowableActions(Actor otherActor, String direction, GameMap map) {
        ...
        if(otherActor.hasCapability(Status.HOSTILE_TO_ENEMY)) {
            if(followBehaviour == null){
                ...
                this.behaviours.add(0, new AttackBehaviour(Status.HOSTILE_TO_ENEMY));
                this.behaviours.add(1, this.followBehaviour);
                this.behaviours.add(2, new AttackBehaviour(Status.PET));
            }
